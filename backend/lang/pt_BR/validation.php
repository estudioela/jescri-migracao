...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'arquivo' => 'arquivo',
        'calcinha_tamanho' => 'tamanho de calcinha',
        'carrossel_qtd' => 'quantidade de carrossel',
        'contato_email' => 'e-mail de contato',
        'contato_nome' => 'nome de contato',
        'contato_telefone' => 'telefone de contato',
        'data_fim' => 'data de fim',
        'data_inicio' => 'data de início',
        'descricao' => 'descrição',
        'entregaveis_esperados' => 'entregáveis esperados',
        'linha_noite_tamanho' => 'tamanho da linha noite',
        'marca_id' => 'marca',
        'motivo' => 'motivo',
        'observacoes' => 'observações',
        'orientacoes' => 'orientações',
        'parceira_id' => 'parceira',
        'prazo' => 'prazo',
        'reels_qtd' => 'quantidade de reels',
        'referencias' => 'referências',
        'status' => 'status',
        'stories_qtd' => 'quantidade de stories',
        'sutia_numeracao' => 'numeração de sutiã',
        'sutia_taca' => 'taça de sutiã',
        'sutia_tamanho' => 'tamanho de sutiã',
        'tipo' => 'tipo',
        'token' => 'token',
        'valor' => 'valor',
