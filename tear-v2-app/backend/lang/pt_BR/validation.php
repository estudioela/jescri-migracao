...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Tradução das mensagens padrão de validação do Laravel para pt_BR.
    | Mesmas chaves do arquivo lang/en/validation.php do framework.
    |
    */
    ...
    'unique' => 'Este valor já está em uso para o campo :attribute.',
