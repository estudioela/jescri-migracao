...
- **Q-03 (resolvido, aprovado pelo PO em 2026-07-15):** rótulos crus
  persistidos são `AGUARDANDO_MATERIAL | EM_REVISAO | APROVADO | PUBLICADO`
  (não os termos do legado "ajustes"/"postado") — ver `EntregaACL.js`
  (cabeçalho). Propagado aqui em 2026-07-16 (achado F7 da auditoria
  SPEC-012, decisão vivia só em comentário de código).
...
| ID | Item | Origem |
|---|---|---|
| D-01 | Rótulos crus persistidos de `EmRevisao`/`Publicado` | ✅ Resolvido — Q-03, PO 2026-07-15: `AGUARDANDO_MATERIAL\|EM_REVISAO\|APROVADO\|PUBLICADO` |
